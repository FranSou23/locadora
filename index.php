    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-lg-8 col-md-6 col-12">
                <h1 class="ms-3">VOCÊ PODE ALUGAR ESTÉ VEÍCULO POR R$ <span id="valor" class="text-primary fw-bolder">99</span>/DIA</h1>
                <P class="ms-3 lead">Válido para todo território nacional</P>
                <div class="text-center">
                <img id=imagem src="basico.png" class="img-fluid w-75" alt="Carro Básico">
                </div>
            </div>
        </div>
    </div>
